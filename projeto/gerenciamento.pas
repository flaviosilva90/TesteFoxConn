...
begin
  ...
  if (ACol = 2) and (CanSelect) and (gridProdutos.Cells[0,ARow] <> '') then
  begin
    Application.CreateForm(associa.TfrmAssocia, frmAssocia);
    try
      frmAssocia.codlancheassocia := gridProdutos.Cells[0,ARow];
      frmAssocia.ShowModal;
    finally
      FreeAndNil(frmAssocia);
    end;
  end;
